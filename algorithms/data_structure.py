...
SAGE
 ...
 Предположим, у нас есть огромное количество корзин, на каждой из которых написано четырёхбуквенное слово, в котором одна буква заменена подчёркиванием. Для примера рассмотрим рисунок 2: у нас есть корзина с меткой pop_. При обработке каждого слова в списке мы сравниваем его с корзинами, используя _ для произвольной подстановки. Таким образом, с pop_. можно связать и pope, и pops. Каждый раз, когда находится связь с корзиной, мы кладём в неё слово. Когда слова разложены, всё, лежащее в одной корзине, должно быть связано между собой.
'''
